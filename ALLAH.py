#created by TANJID
#team bangladesh cyber 71 
#tottaly written by TANJID _ VAI
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
def my_tool_security():
    ...
    print("\t  Fb page  : TANJID Hbf Cammands")
    print("\t  Github   : TANJID-king-06")
    print(c, 45*"-")
    print(47*"-")
    try:
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_TANJID_VAI_CLONE_TOOL.mp3")
    os.getuid
